...
<head>
  ...
  <script type="text/javascript" defer src="form.js"></script>
</head>
...
<body>
  ...
  <nav class="container">
    ...
    <ul>
      ...
      <li>
        <a target="_blank" href="./Form-7.d Packing Credit.html">Form-7.d Packing Credit</a>
      </li>
      <li>
        <a target="_blank" href="./Form-7.e LTR (FC).html">Form-7.e LTR (FC)</a>
      </li>
      <li>
        <a target="_blank" href="./Form-7.f LDBP.html">Form-7.f LDBP</a>
      </li>
      <li>
    ...
    <ul>
      ...
      <li><a target="_blank" href="./allTables.php">All Tables in One</a></li>
      <li><a target="_blank" href="./allForms.php">All Forms in One</a></li>
    </ul>
    </ul>
  </nav>
</body>
